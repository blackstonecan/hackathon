...
from find_one_bfs import find_one_bfs
from find_one_custom import find_one_custom
...
if __name__ == "__main__":
    ...
    for i in range(count):
        ...
        correct_custom, result_custom, distance_custom, time_custom, peak_custom = apply_generic_algorithm(find_one_custom, array, start_x, start_y)
        correct_bfs, result_bfs, distance_bfs, time_bfs, peak_bfs = apply_generic_algorithm(find_one_bfs, array, start_x, start_y)
